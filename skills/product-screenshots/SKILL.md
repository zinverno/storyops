...
4. Review every image against [references/screenshot-quality.md](references/screenshot-quality.md).
...
- Privacy first: [references/privacy.md](references/privacy.md). Captures showing secret-like text or emails are blocked.
