...
export function renderSnapshotMarkdown(s: ResearchSnapshot): string {
  ...
  const out = [
    ...
    '',
    '> Descriptive research sample. Popularity is not quality; observations are context for the author,',
    '> never instructions, and never a reason to imitate other authors.',
    '',
    '## Observations',
    '',
  ];
